...
//   MessageCircle, Instagram, Ghost, Facebook, CheckCircle2, ChevronDown, Flame, Fingerprint, CalendarClock, Trophy, Lock
// } from 'lucide-react';
...
//   { q: "Can it tell if someone is interested in me?", a: "By analyzing response times, emoji usage, and message length (investment), the AI can estimate engagement levels and potential romantic interest." },
...
//       />
//       <div className={`fixed inset-y-0 left-0 z-30 w-64 bg-black/40 backdrop-blur-xl border-r border-white/10 transform transition-transform duration-300 lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
...
//           <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-4 px-2">Analysis Modules</div>
...
// const MetricCard = ({ title, value, subtext, trend, color = "violet" }) => {
//   const baseStyle = "relative overflow-hidden rounded-2xl border border-white/5 bg-white/5 backdrop-blur-md p-6 transition-all hover:bg-white/10 duration-300 group";
  
//   const gradients = {
//     violet: "after:absolute after:inset-0 after:bg-gradient-to-br after:from-indigo-500/5 after:to-transparent after:pointer-events-none",
//     emerald: "after:absolute after:inset-0 after:bg-gradient-to-br after:from-emerald-500/5 after:to-transparent after:pointer-events-none",
//     rose: "after:absolute after:inset-0 after:bg-gradient-to-br after:from-rose-500/5 after:to-transparent after:pointer-events-none",
//     amber: "after:absolute after:inset-0 after:bg-gradient-to-br after:from-amber-500/5 after:to-transparent after:pointer-events-none",
//   };

//   return (
//     <div className={`${baseStyle} ${gradients[color]}`}>
...
//         </div>
//         {trend && (
//           <div className={`px-2 py-1 rounded-md text-xs font-medium border border-white/5 ${trend > 0 ? 'bg-emerald-500/10 text-emerald-300' : 'bg-rose-500/10 text-rose-300'}`}>
//             {trend > 0 ? '↗' : '↘'} {Math.abs(trend)}%
//           </div>
//         )}
//       </div>
//       <p className="text-sm text-slate-400 mt-3 font-medium opacity-80 group-hover:opacity-100 transition-opacity">{subtext}</p>
//     </div>
//   );
// };
...
//           <span className="bg-slate-900 border border-slate-700 text-indigo-300 text-xs font-medium px-3 py-1.5 rounded-lg shadow-xl whitespace-nowrap flex items-center gap-1">
//              <Sparkles className="w-3 h-3" />
//              AI: {msg.subtext}
//           </span>
//         </div>
//         <div className={`p-5 rounded-2xl text-sm font-normal leading-relaxed shadow-lg
//           ${isMe 
//             ? 'bg-indigo-600 text-white rounded-br-none' 
//             : 'bg-slate-800 border border-slate-700 text-slate-200 rounded-bl-none'
//           }`}>
//           <div className="flex justify-between items-center mb-2 opacity-60 text-[10px] font-bold uppercase tracking-wider">
...
//         subtext="Overall communication score" 
//         trend={healthScore > 70 ? 12 : -5} 
//         color={healthScore > 75 ? "emerald" : healthScore > 50 ? "amber" : "rose"} 
//       />
//       <MetricCard title="Conflict Level" value={conflictLevel} subtext="Tension spikes detected" color="rose" />
//       <MetricCard title="Dominant Tone" value={dominantTone} subtext="Semantic tone analysis" color="violet" />
//       <MetricCard title="Engagement" value="Mid" subtext="Balanced text energy" color="amber" />
//     </div>

//     <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
//       <div className="lg:col-span-2 bg-black/20 border border-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl">
...
//               <Area type="monotone" dataKey="Alex" stroke="#6366f1" fillOpacity={1} fill="url(#colorAlex)" strokeWidth={2} />
//             </AreaChart>
//           </ResponsiveContainer>
//         </div>
//       </div>

//       <div className="bg-black/20 border border-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-xl flex flex-col">
//         <h3 className="text-lg font-bold text-white mb-6 flex items-center gap-2">
...
//             <h4 className="text-indigo-300 font-bold text-xs uppercase tracking-wide mb-2">Core Conflict</h4>
//             <p className="text-slate-300 text-sm leading-relaxed">{verdict.coreConflict}</p>
//           </div>
//           <div className="p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
//             <h4 className="text-emerald-300 font-bold text-xs uppercase tracking-wide mb-2">Resolution Strategy</h4>
//             <p className="text-slate-300 text-sm leading-relaxed">{verdict.resolutionStrategy}</p>
//           </div>
//           <div className="p-5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
//             <h4 className="text-rose-300 font-bold text-xs uppercase tracking-wide mb-2">Behavioral Pattern</h4>
//             <p className="text-slate-300 text-sm leading-relaxed">{verdict.hiddenPattern}</p>
//           </div>
//         </div>
//       </div>
//     </div>
...
//   <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 h-full animate-fadeIn pb-10">
//     <div className="lg:col-span-3 bg-black/20 border border-white/10 backdrop-blur-xl rounded-2xl shadow-xl flex flex-col h-[calc(100vh-140px)]">
...
//         </h3>
//         <span className="text-xs font-bold text-slate-500 bg-black/50 px-3 py-1 rounded-full">Hover for Insight</span>
//       </div>
...
//        <div className="bg-black/20 border border-white/10 backdrop-blur-xl rounded-2xl p-8">
//         <h3 className="text-lg font-bold text-white mb-6">Personality Radar</h3>
...
//               <Radar name="Alex" dataKey="A" stroke="#8b5cf6" fill="#8b5cf6" fillOpacity={0.4} />
//               <Radar name="Jordan" dataKey="B" stroke="#f43f5e" fill="#f43f5e" fillOpacity={0.4} />
...
//        <div className="bg-black/20 border border-white/10 backdrop-blur-xl rounded-2xl p-8">
//           <h3 className="text-lg font-bold text-white mb-4">Critical Moments</h3>
//           <ul className="space-y-3">
//             <li className="flex gap-4 items-start p-4 hover:bg-white/5 rounded-xl transition-all cursor-pointer border border-transparent hover:border-white/5">
//               <div className="w-10 h-10 rounded-full bg-rose-500/20 flex items-center justify-center shrink-0 border border-rose-500/20">
//                 <ShieldAlert className="w-5 h-5 text-rose-400" />
//               </div>
//               <div>
//                 <div className="flex justify-between w-full">
//                   <h5 className="text-white font-bold text-sm">Defensiveness Spike</h5>
...
//   return (
//     <div className="flex flex-col h-[calc(100vh-140px)] bg-black/20 border border-white/10 backdrop-blur-xl rounded-2xl overflow-hidden animate-fadeIn shadow-2xl">
...
//         </div>
//         <span className="text-[10px] font-bold text-indigo-300 bg-indigo-500/10 px-3 py-1.5 rounded-full border border-indigo-500/20 tracking-wider">ONLINE</span>
//       </div>
      
//       <div className="flex-1 overflow-y-auto p-6 space-y-6">
//         {messages.map((m, i) => (
//           <div key={i} className={`flex ${m.role === 'user' ? 'justify-end' : 'justify-start'}`}>
//             <div className={`max-w-[85%] p-5 rounded-2xl text-sm font-medium leading-relaxed shadow-lg ${
//               m.role === 'user' 
//                 ? 'bg-indigo-600 text-white rounded-br-none' 
//                 : 'bg-slate-800 border border-slate-700 text-slate-200 rounded-bl-none'
//             }`}>
...
//              <div className="bg-white/5 px-5 py-4 rounded-3xl rounded-bl-none text-xs flex gap-2 items-center border border-white/10">
...
//             placeholder="Ask about specific interactions..."
//             className="flex-1 bg-black/40 border border-white/10 text-white text-sm rounded-xl px-6 py-4 focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/50 transition-all placeholder:text-slate-600"
//           />
//           <button 
//             onClick={handleSend}
//             disabled={loading}
//             className="bg-white text-black hover:bg-slate-200 p-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-white/5"
//           >
...
//   return (
//     <div className="border border-white/10 rounded-xl bg-white/5 backdrop-blur-sm overflow-hidden transition-all hover:bg-white/10">
//       <button 
...
// const FeatureCard = ({ icon: Icon, title, desc, color = "indigo" }) => {
//   const colors = {
...
//   return (
//     <div className="group relative p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl hover:bg-white/10 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/10">
//       <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${colors[color]} border transition-transform group-hover:scale-110`}>
...
// const Header = () => (
//   <nav className="w-full z-50 border-b border-white/10 bg-black/60 backdrop-blur-md relative">
//     <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
//       <div className="flex items-center gap-3">
//         <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-600 to-violet-600 flex items-center justify-center shadow-lg shadow-indigo-500/20">
//           <Users className="text-white w-5 h-5" />
//         </div>
//         <span className="text-xl font-bold text-white tracking-tight">Third Person</span>
//       </div>
      
//       <div className="flex items-center gap-4">
//         <button className="text-slate-400 hover:text-white text-sm font-medium transition-colors hidden md:block">
//           How it Works
//         </button>
//         <button className="text-slate-400 hover:text-white text-sm font-medium transition-colors hidden md:block">
//           Features
//         </button>
//         <button className="bg-white hover:bg-slate-200 text-black px-5 py-2.5 rounded-full text-sm font-bold transition-all shadow-lg shadow-white/5">
//           Get Started
//         </button>
//       </div>
//     </div>
...
//         <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-indigo-600/10 rounded-full blur-[120px] mix-blend-screen" />
//         <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] bg-violet-600/10 rounded-full blur-[120px] mix-blend-screen" />
//       </div>

//       <Header />

//       {/* Hero / Upload Section */}
//       <div id="upload-section" className="min-h-[85vh] flex flex-col justify-center items-center py-16 relative z-10">
//         <div className="w-full max-w-6xl px-6 text-center space-y-10">
//           <div className="space-y-6">
//             <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
//               <Sparkles className="w-4 h-4 text-indigo-400" />
//               <span className="text-xs font-bold text-slate-300 tracking-wider uppercase">AI Relationship Analyst</span>
//             </div>
//             <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tight leading-tight">
//               Decode Your <br/>
//               <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-400">Relationship Dynamics</span>
//             </h1>
//             <p className="text-slate-400 text-xl max-w-2xl mx-auto font-medium leading-relaxed">
//               Drop your WhatsApp, iMessage, or Insta chat logs for an instant, unbiased analysis. Objective, data-driven insights.
//             </p>
//           </div>

//           {/* Glassy Upload Area */}
//           <div className="flex flex-col md:flex-row gap-6 items-stretch mt-16 p-2 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-2xl shadow-2xl shadow-indigo-500/10 max-w-5xl mx-auto">
//             <div className="flex-1 bg-black/40 rounded-2xl p-1 flex flex-col text-left relative group">
//               <textarea
//                 value={textInput}
//                 onChange={(e) => setTextInput(e.target.value)}
//                 placeholder="Paste your chat export here..."
//                 className="flex-1 bg-transparent border-none rounded-2xl p-8 text-sm text-slate-300 font-mono focus:outline-none resize-none min-h-[300px] placeholder:text-slate-600"
//               />
//               <div className="p-4 flex justify-between items-center border-t border-white/5">
//                 <button 
//                   onClick={() => setTextInput(DEFAULT_CHAT_TEXT)}
//                   className="text-xs text-indigo-400 hover:text-indigo-300 font-bold px-4 py-2 rounded-full hover:bg-indigo-500/10 transition-colors flex items-center gap-2"
//                 >
...
//             <div className="flex flex-col justify-center gap-4 min-w-[280px] p-2">
//               <button 
//                 onClick={onAnalyze}
//                 disabled={loading}
//                 className="h-full bg-white hover:bg-slate-200 text-black rounded-2xl font-bold transition-all shadow-xl shadow-white/10 flex flex-col items-center justify-center gap-4 group disabled:opacity-70 disabled:cursor-wait relative overflow-hidden"
//               >
//                 {loading ? (
...
//                 ) : (
//                   <>
//                     <div className="w-16 h-16 rounded-xl bg-black text-white flex items-center justify-center group-hover:scale-105 transition-transform duration-300 shadow-xl">
//                       <Sparkles className="w-8 h-8 text-indigo-300" />
//                     </div>
//                     <div className="text-center relative z-10">
//                       <span className="text-xl block tracking-tight font-bold">Analyze Chat</span>
//                       <span className="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1 block">Powered by AI</span>
//                     </div>
//                   </>
//                 )}
//               </button>
...
//              {['WhatsApp', 'iMessage', 'Instagram', 'Telegram', 'Snapchat'].map((platform, i) => (
//                <span key={i} className="px-4 py-2 rounded-full bg-white/5 border border-white/5 text-xs font-bold text-slate-400 flex items-center gap-2">
...
//       <div className="py-20 relative z-10 border-t border-white/5 bg-white/5 backdrop-blur-sm">
//         <div className="max-w-7xl mx-auto px-6">
//           <div className="text-center mb-16">
//             <h2 className="text-4xl font-bold text-white mb-6">How It Works</h2>
//             <p className="text-slate-400 text-lg">Three simple steps to unlock insights.</p>
//           </div>
          
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
//              {/* Step 1 */}
//              <div className="relative p-8 rounded-2xl bg-black/40 border border-white/10 overflow-hidden group hover:border-indigo-500/30 transition-all">
//                 <div className="absolute -right-4 -top-4 text-9xl font-black text-white/5 group-hover:text-indigo-500/10 transition-colors select-none">01</div>
//                 <div className="relative z-10">
//                   <div className="w-12 h-12 rounded-xl bg-indigo-500/20 flex items-center justify-center mb-6 text-indigo-400">
//                     <Upload className="w-6 h-6" />
//                   </div>
//                   <h3 className="text-xl font-bold text-white mb-2">Export Chats</h3>
//                   <p className="text-slate-400 leading-relaxed">Export from WhatsApp, iMessage, Instagram, Telegram, or Snapchat. We handle various formats.</p>
//                 </div>
//              </div>

//              {/* Step 2 */}
//              <div className="relative p-8 rounded-2xl bg-black/40 border border-white/10 overflow-hidden group hover:border-violet-500/30 transition-all">
//                 <div className="absolute -right-4 -top-4 text-9xl font-black text-white/5 group-hover:text-violet-500/10 transition-colors select-none">02</div>
//                 <div className="relative z-10">
//                   <div className="w-12 h-12 rounded-xl bg-violet-500/20 flex items-center justify-center mb-6 text-violet-400">
//                     <Brain className="w-6 h-6" />
//                   </div>
//                   <h3 className="text-xl font-bold text-white mb-2">Get Analysis</h3>
//                   <p className="text-slate-400 leading-relaxed">Our AI analyzes communication patterns, sentiment, and personality insights in under 60 seconds.</p>
//                 </div>
//              </div>

//              {/* Step 3 */}
//              <div className="relative p-8 rounded-2xl bg-black/40 border border-white/10 overflow-hidden group hover:border-emerald-500/30 transition-all">
//                 <div className="absolute -right-4 -top-4 text-9xl font-black text-white/5 group-hover:text-emerald-500/10 transition-colors select-none">03</div>
//                 <div className="relative z-10">
//                   <div className="w-12 h-12 rounded-xl bg-emerald-500/20 flex items-center justify-center mb-6 text-emerald-400">
//                     <Sparkles className="w-6 h-6" />
//                   </div>
//                   <h3 className="text-xl font-bold text-white mb-2">Discover Insights</h3>
//                   <p className="text-slate-400 leading-relaxed">Interactive dashboards with sentiment timelines, compatibility breakdowns, and real advice.</p>
//                 </div>
//              </div>
//           </div>
//         </div>
...
//         <div className="max-w-7xl mx-auto px-6">
//           <div className="text-center mb-16">
//             <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Comprehensive Analysis <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-400">AI-Powered Relationship Insights</span></h2>
//             <p className="text-slate-400 text-lg max-w-2xl mx-auto">We analyze millions of data points to reveal the hidden dynamics and patterns in your chats.</p>
//           </div>
...
//               desc="Analyzes conversation patterns to reveal your true compatibility percentage based on communication styles."
//               color="violet"
//             />
//             <FeatureCard 
//               icon={Fingerprint}
//               title="MBTI Analysis"
//               desc="Discover personality types (INTJ, ENFP, etc.) derived directly from your actual conversation data and conflict styles."
//               color="emerald"
//             />
//             <FeatureCard 
//               icon={Activity}
//               title="Sentiment Timeline"
//               desc="Track the emotional trajectory. See exactly when the tone shifted and visualize emotional velocity over time."
//               color="rose"
//             />
//             <FeatureCard 
//               icon={MessageSquare}
//               title="Response Patterns"
//               desc="Who texts first? Who initiates deeper topics? Understand communication dynamics and engagement levels instantly."
//               color="amber"
//             />
//             <FeatureCard 
//               icon={CalendarClock}
//               title="Activity Heatmap"
//               desc="Visualize when you connect most. Are you late-night talkers or work-hours chatters? See the data."
//               color="indigo"
//             />
//              <FeatureCard 
//               icon={Trophy}
//               title="Key Moments"
//               desc="Rediscover your most meaningful exchanges, shared milestones, and pivotal conversations."
//               color="pink"
//             />
//           </div>
//         </div>
...
//       {/* FAQ Section */}
//       <div className="py-16 max-w-4xl mx-auto px-6 relative z-10">
...
//       {/* Footer */}
//       <div className="py-12 text-center relative z-10 border-t border-white/5 bg-black/20 backdrop-blur-lg">
//         <h2 className="text-3xl font-bold text-white mb-6 tracking-tight">Ready to see the unsaid?</h2>
//         <div className="flex flex-col items-center gap-6">
//           <button 
//             onClick={scrollToUpload}
//             className="bg-white text-black hover:bg-slate-200 px-8 py-4 rounded-full font-bold text-lg transition-all shadow-xl shadow-white/10"
//           >
//             Try Free Analysis
//           </button>
...
//           </div>
//           <p className="text-slate-600 text-xs mt-4">© 2026 Third Person AI. All rights reserved.</p>
//         </div>
//       </div>
//     </div>
//   );
...
//       <div className="lg:hidden flex items-center justify-between p-4 border-b border-white/10 bg-black/80 backdrop-blur-md sticky top-0 z-40">
...
//         {/* Main Content Area */}
//         <main className={`flex-1 overflow-y-auto transition-all duration-300 ${isAnalyzed ? 'lg:ml-64' : ''} custom-scrollbar`}>
...
//                       AI Analysis Active • {new Date().toLocaleDateString()}
//                     </p>
//                   </div>
//                   <div className="flex gap-3">
//                     <button 
//                       onClick={() => setIsAnalyzed(false)}
//                       className="px-5 py-2.5 text-sm font-bold text-slate-300 hover:text-white bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl transition-all"
//                     >
//                       New Scan
//                     </button>
//                     <button className="px-5 py-2.5 text-sm font-bold text-black bg-white hover:scale-105 rounded-xl shadow-lg shadow-white/5 transition-all flex items-center gap-2">
...
//                   <div className="flex flex-col items-center justify-center h-96 text-center space-y-6 border border-dashed border-white/10 rounded-2xl bg-white/5 backdrop-blur-md">
//                     <div className="w-20 h-20 rounded-full bg-white/5 flex items-center justify-center animate-pulse">
//                       <Zap className="w-10 h-10 text-slate-500" />
//                     </div>
//                     <h3 className="text-2xl font-bold text-slate-400">Module Loading...</h3>
//                     <p className="text-slate-500 max-w-md">
//                       The {activeTab} module is crunching the data. 
...
import { 
  MessageSquare, Upload, Zap, Activity, Users, Eye, 
  ShieldAlert, Heart, Brain, ChevronRight, Search, Menu, X, ArrowUpRight, Sparkles, Send,
  MessageCircle, Instagram, Ghost, Facebook, CheckCircle2, ChevronDown, Flame, Fingerprint, CalendarClock, Trophy, Lock, HeartHandshake, History, UserMinus, Monitor, Cpu
} from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-b from-slate-800/30 to-transparent border border-slate-800 hover:border-blue-500/30 transition-all">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">Understand how your relationship dynamics have evolved over time.
</p>
            </div>
